...
def snapshot_name_from_timestamp(snapshot_path, \
                                 current_fold, plane, stage_code, slice_thickness, organ_ID):
    snapshot_prefix = 'FD' + str(current_fold) + '_' + plane + \
...
def result_name_from_timestamp(result_path, current_fold, \
                               plane, stage_code, slice_thickness, organ_ID,volume_list):
    result_prefix = 'FD' + str(current_fold) + '_' + plane + \
                    stage_code + str(slice_thickness) + '_' + str(organ_ID)
